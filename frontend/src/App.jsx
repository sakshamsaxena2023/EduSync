...
const AppContent = () => {
  ...
  return (
    <div class="min-h-screen bg-darkBg text-gray-100 flex flex-col justify-between">
      <div>
        {/* Navigation Header */}
      ...
      <footer class="border-t border-darkBorder/40 bg-darkCard/20 py-6 text-center text-xs text-gray-500 mt-auto">
        <div class="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4">
          <span>&copy; 2026 EduSync Study Grouping Platform. All rights reserved.</span>
          <span class="text-gray-400">
            Developed by <span class="text-violet-400 font-bold">Saksham Saxena</span> (<a href="mailto:sakshamsaxena18122003@gmail.com" class="hover:text-violet-300 underline transition-colors">sakshamsaxena18122003@gmail.com</a>)
          </span>
        </div>
      </footer>
    </div>
